...
return [
    ...
    'title' => 'Dokumentasi API Employee Shift Scheduling System',

    // A short description of your API. Will be included in the docs webpage, Postman collection and OpenAPI spec.
    'description' => 'API untuk sistem penjadwalan shift karyawan, mengelola departemen, shift, jadwal, dan penugasan.',
    ...
    'intro_text' => <<<INTRO
        ...
        Anda dapat mengubah bahasa yang digunakan dengan tab di kanan atas (atau dari menu navigasi di kiri atas di mobile).</aside>
    INTRO,
    ...
    'auth' => [
        ...
        'extra_info' => 'Anda bisa mendapatkan token dengan login melalui endpoint <code>POST /api/v1/login</code> dan gunakan token yang dikembalikan di header <code>Authorization: Bearer {token}</code>.',
    ],
